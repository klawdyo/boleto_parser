const layouts = {
  BB: {
    code: '001',
    slug: 'bb',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/bb.png',
  ...
  Santander: {
    code: '033',
    slug: 'santander',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/santander.png',
  ...
  Bradesco: {
    code: '237',
    slug: 'bradesco',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/bradesco.png',
    emitter: (bounds) => `${bounds.agency}/${bounds.clientCode}`,
    bounds: {
      agency: [19, 23],
      type: [23, 25],
  ...
  Caixa: {
    code: '104',
    slug: 'caixa',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/caixa.png',
    emitter: (bounds) => `${bounds.clientCode}`,
    bounds: { // casa
      ourNumber: [19, 28],
      clientCode: [28, 44]
  ...
  Itau: {
    code: '341',
    slug: 'itau',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/itau.png',
  ...
  Inter: {
    code: '077',
    slug: 'inter',
    logo: 'https://storage.googleapis.com/static-g3dobrasil-com-br/banks/inter.png',
    emitter: (bounds) => `${bounds.agency}/${bounds.clientCode}`,
    bounds: {
      agency: [19, 23],
      type: [23, 26], // carteira
...
function convertBarcodeToLine(barcode) {
  ...
  const splitLine = (barcode, parts, separator = '') => {
    return parts
      .reduce((accu, curr) => accu + barcode.substring(curr[0], curr[1]) + separator, '')
  }
...
function mod10(value) {
  ...
  // sempre seja o 2
  const getMultipliers = (value) => [...Array(value.length)]
    .map((_, i) => ((i + 1) % 2) + 1)
    .reverse()
